...
import de.fehngarten.fhemswitch.config.listviews.ConfigPagerAdapter2;
...
public class ConfigMain2 extends Activity {
    ...
    private ConfigPagerAdapter2 configPagerAdapter;
...
/*
        new SetViewWidth(findViewById(R.id.configView), Math.round(725 * density));
        new SetViewWidth(findViewById(R.id.config_block_0), Math.round(710 * density));
        new SetViewWidth(findViewById(R.id.config_block_1), Math.round(710 * density));
        new SetViewWidth(findViewById(R.id.config_block_2), Math.round(710 * density));
        new SetViewWidth(findViewById(R.id.config_block_3), Math.round(710 * density));
        new SetViewWidth(findViewById(R.id.config_block_4), Math.round(710 * density));
        new SetViewWidth(findViewById(R.id.config_block_5), Math.round(710 * density));
*/
        /*
        View.OnTouchListener handleTouch = (v, event) -> {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    //View.smoothScrollTo(Math.round(710 * density) , 0);
                    break;
...
*/
    ...
    public void buildOutput() {
        ...
        configPagerAdapter = new ConfigPagerAdapter2(mContext, mySocket);
    ...
    private void hilightTab(int pos) {
        ...
        tabView.setBackgroundResource(R.drawable.tabssel);
